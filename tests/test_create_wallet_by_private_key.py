...
class TestCreateWalletByPrivateKey(unittest.TestCase):
    ...
    def test0(self):
        ...
        """
        wallet1 = Wallet.create_wallet_by_private_key('71fc378d3a3fb92b57474af156f376711a8a89d277c9b60a923a1db75575b1cc')[0]
    ...
    def test1(self):
        ...
        """
        try:
            wallet1 = Wallet.create_wallet_by_private_key('71fc378d3a3fb92b57474af156f9d277c9b60a923a1db75575b1cc')[0]
        except TypeError:
